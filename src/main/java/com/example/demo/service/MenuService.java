...
public class MenuService {
	...
	MenuService(DailyReportService dailyReportService, DateHelper dateHelper,
			...
			WeatherService weatherService,MonthlyAttendanceReqService monthlyAttendanceReqService,CommonActivityService commonActivityService) {
	...
	public void backMenu(Model model, HttpSession session) {
		...
		Users users = commonActivityService.getCommonInfoAddUsers(model,session,infoAboutMenu);
