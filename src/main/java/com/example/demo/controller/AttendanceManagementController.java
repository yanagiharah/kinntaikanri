...
public class AttendanceManagementController {
	...
	public String attendanceSearch(Integer userId, String stringYearsMonth, Model model,
		...
		AttendanceFormList attendanceFormList = attendanceManagementService.setInAttendance(attendance,years,month,stringYearsMonth);
	...
	public String monthlyAttendanceReqCreate(MonthlyAttendanceReq monthlyAttendanceReq,
		...
		monthlyAttendanceReqService.monthlyAttendanceUpdate(attendanceFormList.getAttendanceList().get(0).getAttendanceDate(), monthlyAttendanceReq.getUserId(),monthlyAttendanceReq,attendanceFormList);
		monthlyAttendanceReqService.submissionStatusCheck(attendanceFormList.getAttendanceList().get(0).getAttendanceDate(), users.getUserId(),model,session);
		model.addAttribute("attendanceFormList", attendanceFormList);
		return "attendance/registration";
	}
